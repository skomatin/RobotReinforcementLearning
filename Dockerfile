...
RUN apt-get -y install htop cmake libopenmpi-dev python3-dev zlib1g-dev
...
RUN pip install --no-cache-dir networkx scipy stable-baselines[mpi] pettingzoo[all] supersuit
